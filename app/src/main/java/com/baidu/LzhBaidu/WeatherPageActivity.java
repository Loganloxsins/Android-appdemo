...
public class WeatherPageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i <= 24; i++) {
            ...
            switch(i) {
                case 1:
                    weatherItem = new Weather_Item("12:00", "21°C", R.drawable.rainy);
                    weatherList.add(weatherItem);
                    break;
                case 2:
                    weatherItem = new Weather_Item("13:00", "21°C", R.drawable.cloudy);
                    weatherList.add(weatherItem);
                    break;
                case 3:
                    weatherItem = new Weather_Item("14:00", "25°C", R.drawable.cloudy);
                    weatherList.add(weatherItem);
                    break;
                case 4:
                    weatherItem = new Weather_Item("15:00", "28°C", R.drawable.clear);
                    weatherList.add(weatherItem);
                    break;
                case 5:
                    weatherItem = new Weather_Item("16:00", "30°C", R.drawable.clear);
                    weatherList.add(weatherItem);
                    break;
                case 6:
                    weatherItem = new Weather_Item("17:00", "32°C", R.drawable.cloudy);
                    weatherList.add(weatherItem);
                    break;
                case 7:
                    weatherItem = new Weather_Item("18:00", "30°C", R.drawable.cloudy);
                    weatherList.add(weatherItem);
                    break;
                default:
                    String time;
                    ...
                    Weather_Item weatherItem_default = new Weather_Item(time+":00", "29°C", R.drawable.cloudy);
